...
export default function CustomContextMenu(props) {
  ...
  function handleCopy() {
    ...
    if (selectedText) {
      ...
      if (tempInput.parentNode?.contains(tempInput)) {
  ...
  // Config values with proper booleans
  const CUSTOM_RIGHT_CLICK_CONTEXT_MENU_RANDOM_POST = JSON.parse(
    siteConfig('CUSTOM_RIGHT_CLICK_CONTEXT_MENU_RANDOM_POST')
  )
  const CUSTOM_RIGHT_CLICK_CONTEXT_MENU_CATEGORY = JSON.parse(
    siteConfig('CUSTOM_RIGHT_CLICK_CONTEXT_MENU_CATEGORY')
  )
  const CUSTOM_RIGHT_CLICK_CONTEXT_MENU_TAG = JSON.parse(
    siteConfig('CUSTOM_RIGHT_CLICK_CONTEXT_MENU_TAG')
  )
  const CAN_COPY = JSON.parse(siteConfig('CAN_COPY'))
  const CUSTOM_RIGHT_CLICK_CONTEXT_MENU_SHARE_LINK = JSON.parse(
    siteConfig('CUSTOM_RIGHT_CLICK_CONTEXT_MENU_SHARE_LINK')
  )
  const CUSTOM_RIGHT_CLICK_CONTEXT_MENU_DARK_MODE = JSON.parse(
    siteConfig('CUSTOM_RIGHT_CLICK_CONTEXT_MENU_DARK_MODE')
  )
  const CUSTOM_RIGHT_CLICK_CONTEXT_MENU_THEME_SWITCH = JSON.parse(
