...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Master in marketing analytics', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'notion-next-39os.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yunzhu', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Welcome to my website!', 'Here you can find all my experience',
